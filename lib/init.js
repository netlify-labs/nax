...
function ensureNetlifyProject({ projectRoot, repo, siteId, siteName, create = false, dryRun = false, env = process.env, runCommand = run, readProject = readNetlifyProject } = {}) {
