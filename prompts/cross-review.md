...
7. If the checked-out SHA does **not** exactly match the pinned SHA from the Additional Context, stop and return a repository-state mismatch report instead of reviewing a different tree.
