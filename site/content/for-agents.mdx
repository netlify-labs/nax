...
Local execution starts large lineups in waves with at most five non-terminal
runners. Above six instances in a step, use `--force` only when the user has
already approved the cost fan-out.
