...
`agent-runner-sdk` is the shared Node.js lifecycle client for Netlify Agent
...
```ts copy
import { isAgentRunnerSdkError } from 'agent-runner-sdk'
...
- Package-specific Git tags: `agent-runner-sdk-vX.Y.Z`
...
that tarball into clean ESM and CommonJS consumers. Publication remains a
manual, explicitly authorized step.
