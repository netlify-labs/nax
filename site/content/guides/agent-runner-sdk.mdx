...
See the package's
[`eventbridge-resume.ts`](https://github.com/netlify-labs/nax/blob/master/packages/agent-runner-sdk/examples/eventbridge-resume.ts)
...
- Stable distribution tag: `latest`
