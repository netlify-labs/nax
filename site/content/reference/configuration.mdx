...
Project config files may use YAML, JSON, TOML, or a JavaScript/TypeScript file
containing a single JSON5-compatible static object export. Dynamic module code
is blocked during flow discovery.
