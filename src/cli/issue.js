...
const { listPrompts, resolveRepo, titleCase } = require('../prompts')
const { assertCrossReviewComplete, rawIssuesFromResults } = require('../round-results')
 ...
 * @typedef {import('../github/issue-plan').GithubPlanOptions & {
 *   yes?: boolean,
 *   dryRun?: boolean,
 *   projectRoot?: string,
 ...
 *   ) => import('../github/issue-plan').GithubIssuePlan | import('../github/issue-plan').GithubCommentPlan,
...
function createIssueHandlers({ buildAndMaybeFallbackPlan, loadClack = defaultLoadClack, exit = process.exit }) {
  ...
  async function handleIssue(promptName, options) {
    ...
    const plan = /** @type {import('../github/issue-plan').GithubIssuePlan} */ (
  ...
  async function handleComment(promptName, options) {
    ...
    const plan = /** @type {import('../github/issue-plan').GithubCommentPlan} */ (
