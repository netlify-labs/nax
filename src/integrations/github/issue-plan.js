...
const { buildAutomaticContext } = require('../git/review-context')
const {
  buildIssueBody,
  buildIssueTitle,
  getLocalDate,
...
const { fetchRoundResults, formatRoundResults } = require('../../workflows/round-results')
 ...
 * @returns {import('../../workflows/round-results').RoundResult[]}
 */
 ...
 * @param {import('../../workflows/round-results').RoundResult[]} [results]
...
/** @param {string} heading @param {import('../../workflows/round-results').RoundResult[]} results @returns {string} */
